...
const NAME: &str = "micro_return_std";
const WINDOW: usize = 60;
const WINDOW_SECONDARY: usize = 60;

/// Formula/logic: rolling push: input.ret.or(last_ret); value = rolling_a.std()
/// Inputs: ret
/// Output: state.value (factor value)
#[derive(Debug)]
pub struct MicroReturnStd {
...
impl Display for MicroReturnStd {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(f, "{}()", NAME)
    }
}

impl Indicator for MicroReturnStd {
    fn name(&self) -> String {
        NAME.to_string()
    }
...
impl ValueIndicator for MicroReturnStd {
    fn value(&self) -> f64 {
        self.state.value
    }
}
