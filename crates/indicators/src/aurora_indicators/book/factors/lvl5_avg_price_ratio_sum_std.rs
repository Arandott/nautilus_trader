...
const NAME: &str = "lvl5_avg_price_ratio_sum_std";
const WINDOW: usize = 60;
const WINDOW_SECONDARY: usize = 60;

/// Formula/logic: rolling push: base; value = rolling_a.std()
/// Inputs: ask_price, bid_price
/// Output: state.value (factor value)
#[derive(Debug)]
pub struct Lvl5AvgPriceRatioSumStd {
    state: BookFactorState,
}

impl Lvl5AvgPriceRatioSumStd {
    #[must_use]
    pub fn new() -> Self {
        Self {
...
impl Display for Lvl5AvgPriceRatioSumStd {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(f, "{}()", NAME)
    }
}

impl Indicator for Lvl5AvgPriceRatioSumStd {
    fn name(&self) -> String {
        NAME.to_string()
    }
...
impl ValueIndicator for Lvl5AvgPriceRatioSumStd {
    fn value(&self) -> f64 {
        self.state.value
    }
}
...
mod tests {
    ...
    use super::Lvl5AvgPriceRatioSumStd;
    use crate::aurora_indicators::ValueIndicator;
    use crate::indicator::Indicator;
    use approx::assert_relative_eq;

    #[test]
    fn test_lvl5_avg_price_ratio_sum_std_value() {
        let book = sample_book();
        let mut factor = Lvl5AvgPriceRatioSumStd::new();
    ...
    #[test]
    fn test_lvl5_avg_price_ratio_sum_std_empty_book() {
        let book = empty_book();
        let mut factor = Lvl5AvgPriceRatioSumStd::new();
        factor.handle_book(&book);
        assert!(factor.has_inputs());
