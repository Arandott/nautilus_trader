...
# Conditional compilation for extended bar fields
# Import the configuration that defines HAS_EXTENDED_BAR_FIELDS
include "_generated/extended_bar_config.pxi"

# Include field specifications if extended fields are enabled
IF HAS_EXTENDED_BAR_FIELDS:
    include "_generated/extended_bar_field_specs.pxi"

# Conditionally include the appropriate Bar class implementation
IF HAS_EXTENDED_BAR_FIELDS:
    # Use the generated extended Bar class with additional fields
    include "_generated/_extended_bar__bar.pxi"
ELSE:
    cdef class Bar(Data):
        """
