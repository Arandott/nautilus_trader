...
from nautilus_trader.model.events import OrderFilled, PositionOpened, PositionChanged, PositionClosed
...
class FactorExpLiveStrategy(Strategy):
    ...
    def __init__(self, config: FactorExpLiveStrategyConfig) -> None:
        ...
        self._cached_commission_rate: Optional[Decimal] = None
        
        # Native risk sizer - will be initialized in on_start
        self._position_sizer: Optional[FixedRiskSizer] = None
        
        # FactorExp indicators - using ONLY verified operators
        self._ema_ratio_indicator: Optional[FactorExpIndicator] = None
        self._volatility_indicator: Optional[FactorExpIndicator] = None
        self._momentum_indicator: Optional[FactorExpIndicator] = None
        self._mean_reversion_indicator: Optional[FactorExpIndicator] = None
        ...
        if hasattr(self, 'log') and self.log:
            ...
            print(f"❌ [TEST] FactorExpLiveStrategy logger NOT available during __init__")
    ...
    def on_start(self):
        ...
        self.log.info(f"🔍 [TEST] on_start() method called")
    ...
    def on_quote_tick(self, tick: QuoteTick):
        ...
        pass  # Not used for this strategy

    def on_trade_tick(self, tick: TradeTick):
        """Handle trade tick data."""
        pass  # Using bar data primarily
    ...
    def _calculate_position_size(self, entry_price: float, is_long: bool) -> Optional[object]:
        """
    ...
    def _get_current_notional_exposure(self) -> Optional[float]:
        """
    ...
    def _get_current_position_size(self) -> Optional[Quantity]:
        """
