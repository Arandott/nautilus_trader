...
const NAME: &str = "lvl5_avg_price_ratio_sum_kurtosis";
const WINDOW: usize = 60;
const WINDOW_SECONDARY: usize = 60;

/// Formula/logic: rolling push: base; value = rolling_a.kurtosis()
/// Inputs: ask_price, bid_price
/// Output: state.value (factor value)
#[derive(Debug)]
pub struct Lvl5AvgPriceRatioSumKurtosis {
    state: BookFactorState,
}

impl Lvl5AvgPriceRatioSumKurtosis {
    #[must_use]
    pub fn new() -> Self {
        Self {
    ...
    pub fn update(&mut self, book: &OrderBook) {
        ...
        self.state.value = self.state.rolling_a.kurtosis();
...
impl Display for Lvl5AvgPriceRatioSumKurtosis {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(f, "{}()", NAME)
    }
}

impl Indicator for Lvl5AvgPriceRatioSumKurtosis {
    fn name(&self) -> String {
        NAME.to_string()
    }
...
impl ValueIndicator for Lvl5AvgPriceRatioSumKurtosis {
    fn value(&self) -> f64 {
        self.state.value
    }
}
...
mod tests {
    ...
    use super::Lvl5AvgPriceRatioSumKurtosis;
    use crate::aurora_indicators::ValueIndicator;
    use crate::indicator::Indicator;
    use approx::assert_relative_eq;

    #[test]
    fn test_lvl5_avg_price_ratio_sum_kurtosis_value() {
        let book = sample_book();
        let mut factor = Lvl5AvgPriceRatioSumKurtosis::new();
    ...
    #[test]
    fn test_lvl5_avg_price_ratio_sum_kurtosis_empty_book() {
        let book = empty_book();
        let mut factor = Lvl5AvgPriceRatioSumKurtosis::new();
        factor.handle_book(&book);
        assert!(factor.has_inputs());
